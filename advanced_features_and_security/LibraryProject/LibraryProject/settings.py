...
# Useful when your app is behind a proxy (e.g., Nginx, Heroku, AWS ELB)
...
## Meaning: If the request contains the header 'HTTP_X_FORWARDED_PROTO=https', Django will treat the request as secure (HTTPS)
